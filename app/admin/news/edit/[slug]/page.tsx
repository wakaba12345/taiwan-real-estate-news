            ...
            <div className="bg-white rounded-lg border overflow-hidden">
              <div className="bg-indigo-700 text-white text-xs font-bold px-4 py-2 uppercase tracking-wide flex items-center justify-between">
                ...
                <div className="flex items-center gap-3">
                  ...
                  {/* 預覽 / 編輯 切換 */}
                  <div className="flex rounded overflow-hidden border border-indigo-400">
                    <button onClick={() => setRightTab("preview")}
                      className={`px-3 py-0.5 text-xs font-normal ${rightTab === "preview" ? "bg-white text-indigo-700" : "text-indigo-200 hover:text-white"}`}>
                      預覽
                    </button>
                    <button onClick={() => setRightTab("edit")}
                      className={`px-3 py-0.5 text-xs font-normal ${rightTab === "edit" ? "bg-white text-indigo-700" : "text-indigo-200 hover:text-white"}`}>
                      編輯
                    </button>
                  </div>
                </div>
                ...
                <div>
                  ...
                  {rightTab === "preview" ? (
                    <div
                      ...
                      dangerouslySetInnerHTML={{ __html: renderBodyHtml(editBody) }}
                    />
                  ) : (
                    <textarea
                      value={editBody}
